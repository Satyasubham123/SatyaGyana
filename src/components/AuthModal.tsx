...
export default function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  return (
    <AnimatePresence>
      {/* 🚀 FIX: The Safe-Scroll Wrapper. This prevents the top from getting cut off on small laptops! */}
      <div className="fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-sm">
        <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
          ...
          <motion.div 
            ...
            className="w-full max-w-md bg-slate-900 rounded-[32px] border border-slate-800 shadow-2xl text-left overflow-hidden my-8 flex flex-col relative"
          >
            {/* Header */}
