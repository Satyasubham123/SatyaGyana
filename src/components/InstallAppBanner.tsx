...
export default function InstallAppBanner() {
  ...
  useEffect(() => {
    ...
    const handleAppInstalled = () => {
      ...
      console.log('GyanaMitra App was installed!');
    };
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 animate-in slide-in-from-bottom-5">
      <div className="max-w-md mx-auto bg-slate-900 border border-brand/30 shadow-2xl shadow-brand/20 rounded-2xl p-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <img src="/pwa-192x192.png" alt="GyanaMitra Icon" className="w-12 h-12 rounded-xl" />
          <div className="flex flex-col">
            <span className="text-white font-bold leading-tight text-lg">GyanaMitra App</span>
