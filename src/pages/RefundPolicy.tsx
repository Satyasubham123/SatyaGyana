      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-[32px] p-8 sm:p-12 shadow-2xl">
          ...
          <div className="prose prose-invert max-w-none text-slate-300 space-y-6 text-sm sm:text-base leading-relaxed">
            ...
            <p>
              If you have any questions regarding your billing, account, or need assistance cancelling your subscription, please email our support team at <a href="mailto:biswalsatya321@gmail.com" className="text-brand hover:underline font-bold">support@gyanmitra.com</a>.
            </p>
          </div>
        </div>
      </div>
