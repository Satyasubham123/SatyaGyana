...
// 🚀 UPDATED: Removed `export const AIVisualizer` and made it the default export so it routes correctly
export default function AIVisualizer() {
  ...
  return (
    // 🚀 FIXED: Set background to transparent or deep so it inherits the app theme
    <div className="p-4 sm:p-8 max-w-6xl mx-auto min-h-screen pt-24 text-slate-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6 lg:col-span-1">
          ...
          {/* 🚀 FIXED: Switched to dark mode card styling */}
          ...
          <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-3xl shadow-xl backdrop-blur-sm">
            ...
            {/* 🚀 FIXED: Text area is now dark, with white text and a glowing focus ring */}
            <textarea
              className="w-full p-4 border border-slate-700 rounded-2xl bg-slate-950/80 text-white placeholder-slate-500 focus:ring-2 focus:ring-brand focus:border-transparent outline-none transition-all resize-none text-sm font-medium leading-relaxed"
              rows={5}
        ...
        {/* 🚀 FIXED: Image display box is now dark to match */}
